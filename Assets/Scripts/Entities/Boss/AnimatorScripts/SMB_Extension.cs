...
public class SMB_Extension<TMonoBehaviour> : SealedSMB where TMonoBehaviour : MonoBehaviour
{
    ...
    {
        SMB_Extension<TMonoBehaviour>[] sceneLinkedSMBs = animator.GetBehaviours<SMB_Extension<TMonoBehaviour>>();
    ...
    /// <summary>
    /// Called on the last frame of the state before going to the transition.
    /// </summary>
    public virtual void OnSLStateFinished(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) { }
    ...
    /// Called on the last frame of the state before going to the transition.
    /// </summary>
    public virtual void OnSLStateFinished(Animator animator, AnimatorStateInfo stateInfo, int layerIndex, AnimatorControllerPlayable controller) { }
}
